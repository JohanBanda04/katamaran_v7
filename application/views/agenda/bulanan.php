      ...
      <a
        ...
        <div class="peer wrap-text-agenda">
          ...
          <?php if($row['status'] == 'belum'): ?>
            <span class="badge bgc-red-50 c-red-700 p-10 lh-0 tt-c badge-pill">Belum disetujui. Silakan hubungi protokoler.</span>
          ...
          <?php elseif($row['status'] == 'tolak'): ?>
            <span class="badge bgc-orange-50 c-orange-700 p-10 lh-0 tt-c badge-pill">Ditolak / Butuh Koreksi. Silakan hubungi protokoler.</span>
          <?php endif; ?>
        </div></a
      >
