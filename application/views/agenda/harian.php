      ...
      <a
        ...
        <div class="peer wrap-text-agenda">
          ...
          <?php if($row['status'] == 'belum'): ?>
            <span class="badge bgc-orange-50 c-orange-700 p-10 lh-0 tt-c badge-pill">Belum disetujui. Silakan hubungi protokoler.</span>
          ...
          <?php elseif($row['status'] == 'tolak'): ?>
            <span class="badge bgc-red-50 c-red-700 p-10 lh-0 tt-c badge-pill">Ditolak / Butuh Koreksi. Silakan hubungi protokoler.</span>
          <?php endif; ?>
        </div>
      </a>
      <div class="peers mR-15">
        ...
        <div class="peer">
          ...
          <div class="peer">
            <a
              href=""
              class="td-n c-green-500 cH-blue-500 fsz-md p-5"
              data-toggle="modal"
              data-target="#proses_agenda<?php echo $row['id']; ?>"
              ><i class="ti-write"></i
            ><span style="font-size: 16px; padding-left: 4px;">Proses</span></a>
          </div>
        <?php endif; endif; ?>
      </div>
    </li>
