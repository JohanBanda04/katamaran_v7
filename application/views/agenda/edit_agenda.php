                ...
                <div class="modal-body">
                    <form method="POST" action="agenda/v/e" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control border-grey" id="pejabat" name="pejabat"
                                   value="<?php echo $row['pejabat'] ?>" required/>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control border-grey" id="penanggungjawab" name="penanggungjawab"
                                   value="<?php echo $row['penanggungjawab'] ?>" required/>
                        </div>
